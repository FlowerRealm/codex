...
const PLATFORM_PACKAGE_BY_TARGET: Record<string, string> = {
  ...
  "aarch64-unknown-linux-musl": `${CODEX_NPM_NAME}-linux-arm64`,
  "x86_64-apple-darwin": `${CODEX_NPM_NAME}-darwin-x64`,
  "aarch64-apple-darwin": `${CODEX_NPM_NAME}-darwin-arm64`,
  "x86_64-pc-windows-msvc": `${CODEX_NPM_NAME}-win32-x64`,
  "aarch64-pc-windows-msvc": `${CODEX_NPM_NAME}-win32-arm64`,
};
