...
<p align="center"><code>npm i -g @flowerrealm/realmx</code></p>
...
- **macOS 12+** - commands are wrapped with **Apple Seatbelt** (`sandbox-exec`).
  ...
  - Everything is placed in a read-only jail except for a small set of
    writable roots (`$PWD`, `$TMPDIR`, `~/.realmx`, etc.).
...
1. `~/.realmx/AGENTS.md` - personal global guidance
...
npm install -g @flowerrealm/realmx
# or
yarn global add @flowerrealm/realmx
# or
bun install -g @flowerrealm/realmx
# or
pnpm add -g @flowerrealm/realmx
```
...
Codex configuration files can be placed in the `~/.realmx/` directory, supporting both YAML and JSON formats.
...
1. YAML format (save as `~/.realmx/config.yaml`):
...
2. JSON format (save as `~/.realmx/config.json`):
...
You can create a `~/.realmx/AGENTS.md` file to define custom guidance for the agent:
...
You may need to upgrade to a more recent version with: `npm i -g @flowerrealm/realmx@latest`
