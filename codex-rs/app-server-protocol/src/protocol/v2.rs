...
pub struct ExternalAgentConfigDetectParams {
    /// If true, include detection under the user's home (~/.claude, ~/.realmx, etc.).
...
pub enum Account {
    ...
    #[ts(rename = "oauth", rename_all = "camelCase")]
    Oauth {},
...
pub enum LoginAccountResponse {
    ...
    #[serde(rename = "oauth", rename_all = "camelCase")]
    #[ts(rename = "oauth", rename_all = "camelCase")]
    Oauth { login_id: String, auth_url: String },
    #[serde(rename = "chatgpt", rename_all = "camelCase")]
    #[ts(rename = "chatgpt", rename_all = "camelCase")]
    Chatgpt {
        ...
        let user_item = TurnItem::UserMessage(UserMessageItem {
            ...
            content: vec![
                ...
                CoreUserInput::Skill {
                    ...
                    path: PathBuf::from("/repo/.realmx/skills/skill-creator/SKILL.md"),
                },
